...
int main()
{
    ...
    //----------------
    Shader lampShader("shaders/lightmap/lamp.vs", "shaders/lightmap/lamp.fs");
    Shader lightingShader("shaders/lightmap/basicShader.vs", "shaders/lightmap/basicShader.fs");
