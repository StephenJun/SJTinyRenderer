...
int main()
{
    ...
    //----------------
    Shader lampShader("shaders/material/lamp.vs", "shaders/material/lamp.fs");
    Shader lightingShader("shaders/material/basicShader.vs", "shaders/material/basicShader.fs");
